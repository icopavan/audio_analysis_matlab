...
%SIGDEMO2 Interactive signal example - 2 : continuous FT of a signal
%   This example shows how to illustrate basic Fourier transform (FT)
%   properties, including modulation. The example uses MATLAB's graphic
%   user interface using Handle Graphics.
...
elseif strcmp(action,'info'),
    ...
    hlpStr= ...                                              
        ['You are seeing a representation of a continuous function (the upper plot)  '
         ...
         'This example lets you change the modulation frequency, as well as the      '
