...
%
% This example shows how to use the "pwelch" function in the Signal
% Processing Toolbox.
%
...
if strcmp(action,'initialize'),
    ...
    if ~feature('hgusingmatlabclasses')
        set([axHndl1 axHndl2],'DrawMode','fast');
    end
    ...
    set(figNumber,'Visible','on', ...
        'UserData',[double(frmHndl) double(infoHndl) double(closeHndl) double(plot1Hndl) double(plot2Hndl) double(sndHndl)]);
